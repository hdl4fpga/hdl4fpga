...
set_max_delay -datapath_only 1.5 -from [ get_pins scope_e/ddr_e/xdr_sch_e/xdr_rph_e/gn[*].q_reg[*]__0/C ] -to [ get_pins ddrphy_e/byte_g[*].ddrdqphy_i/dqso_b.adjsto_e/st_reg/D ]
set_max_delay -datapath_only 1.5 -from [ get_pins scope_e/ddr_e/xdr_sch_e/xdr_rph_e/gn[*].q_reg[*]__0/C ] -to [ get_pins ddrphy_e/byte_g[*].ddrdqphy_i/dqso_b.adjsto_e/start_reg/D ]
set_max_delay -datapath_only 1.5 -from [ get_pins scope_e/ddr_e/xdr_sch_e/xdr_rph_e/gn[*].q_reg[*]__0/C ] -to [ get_pins ddrphy_e/byte_g[*].ddrdqphy_i/dqso_b.adjsto_e/dly_reg[*]/D ]
