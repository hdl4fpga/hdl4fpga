...
set_false_path -from [ get_pins scope_e/ddr_e/rdfifo_i/sys_do_win_reg/C ] -to [ get_pins scope_e/ddr_e/rdfifo_i/bytes_g[*].data_phases_g[*].inbyte_i/phases_g[*].ar_g.gcntr_g[*].ffd_i/CLR ]
