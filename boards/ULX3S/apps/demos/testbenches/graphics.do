...
add wave -noupdate -radix hexadecimal /testbench/du_e/grahics_e/adapter_b/graphics_e/vram_e/max_depthgt1_g/mem_e/rd_data
...
WaveRestoreCursors {{Cursor 1} {222764652150 fs} 0} {{Cursor 2} {433426665410 fs} 0} {{Cursor 3} {747262477990 fs} 0}
...
update
WaveRestoreZoom {747081997380 fs} {747492153640 fs}
