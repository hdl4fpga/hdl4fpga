...
add wave -noupdate -divider {New Divider}
add wave -noupdate /testbench/du_e/sdrphy_b/sdrphy_e/sys_sto
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_b/sdrphy_e/sys_dqo
add wave -noupdate /testbench/du_e/sdrphy_b/sdrphy_e/byte_g(0)/sdrphy_i/iddr_g(0)/gear1or2_g/ibx_i/sclk
add wave -noupdate /testbench/du_e/sdrphy_b/sdrphy_e/byte_g(0)/sdrphy_i/iddr_g(0)/gear1or2_g/ibx_i/d
add wave -noupdate /testbench/du_e/sdrphy_b/sdrphy_e/byte_g(0)/sdrphy_i/iddr_g(0)/gear1or2_g/ibx_i/q
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_b/sdrphy_e/byte_g(0)/sdrphy_i/sys_dqo
add wave -noupdate -divider {New Divider}
