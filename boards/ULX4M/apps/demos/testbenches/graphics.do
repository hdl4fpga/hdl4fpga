...
add wave -noupdate -group ddram /testbench/du_e/ddram_dqs
...
WaveRestoreCursors {{Cursor 1} {13422549020 fs} 0} {{Cursor 2} {55971609260 fs} 0}
...
update
WaveRestoreZoom {5050 ns} {26050 ns}
