...
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(0)/ddr3phy_i/lat(1)
...
WaveRestoreCursors {{Cursor 1} {16648760000 fs} 0} {{Cursor 2} {23493974920 fs} 0}
...
update
WaveRestoreZoom {18014984200 fs} {24315000840 fs}
