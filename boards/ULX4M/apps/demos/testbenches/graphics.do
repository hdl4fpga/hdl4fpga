...
add wave -noupdate -radix hexadecimal -childformat {{/testbench/dd(15) -radix hexadecimal} {/testbench/dd(14) -radix hexadecimal} {/testbench/dd(13) -radix hexadecimal} {/testbench/dd(12) -radix hexadecimal} {/testbench/dd(11) -radix hexadecimal} {/testbench/dd(10) -radix hexadecimal} {/testbench/dd(9) -radix hexadecimal} {/testbench/dd(8) -radix hexadecimal} {/testbench/dd(7) -radix hexadecimal} {/testbench/dd(6) -radix hexadecimal} {/testbench/dd(5) -radix hexadecimal} {/testbench/dd(4) -radix hexadecimal} {/testbench/dd(3) -radix hexadecimal} {/testbench/dd(2) -radix hexadecimal} {/testbench/dd(1) -radix hexadecimal} {/testbench/dd(0) -radix hexadecimal}} -subitemconfig {/testbench/dd(15) {-radix hexadecimal} /testbench/dd(14) {-radix hexadecimal} /testbench/dd(13) {-radix hexadecimal} /testbench/dd(12) {-radix hexadecimal} /testbench/dd(11) {-radix hexadecimal} /testbench/dd(10) {-radix hexadecimal} /testbench/dd(9) {-radix hexadecimal} /testbench/dd(8) {-radix hexadecimal} /testbench/dd(7) {-radix hexadecimal} /testbench/dd(6) {-radix hexadecimal} /testbench/dd(5) {-radix hexadecimal} /testbench/dd(4) {-radix hexadecimal} /testbench/dd(3) {-radix hexadecimal} /testbench/dd(2) {-radix hexadecimal} /testbench/dd(1) {-radix hexadecimal} /testbench/dd(0) {-radix hexadecimal}} /testbench/dd
add wave -noupdate -radix hexadecimal /testbench/du_e/graphics_e/ctlrphy_sti
add wave -noupdate -radix hexadecimal /testbench/mt_u/dq
...
WaveRestoreCursors {{Cursor 1} {52556250000 fs} 1} {{Cursor 2} {63197069340 fs} 0}
...
update
WaveRestoreZoom {63141840320 fs} {63213159680 fs}
