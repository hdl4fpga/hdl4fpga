...
add wave -noupdate /testbench/du_e/ddrphy_e/ddr_dqi(1)
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/ddr_dqsi
add wave -noupdate -divider {New Divider}
...
WaveRestoreCursors {{Cursor 1} {14366111 ps} 1} {{Cursor 2} {23816815 ps} 0} {{Cursor 3} {23980812 ps} 0}
...
update
WaveRestoreZoom {23775732 ps} {24185892 ps}
