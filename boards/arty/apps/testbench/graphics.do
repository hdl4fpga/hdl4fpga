...
add wave -noupdate -expand -group adjdqs1 /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/tap4
...
add wave -noupdate -expand -group adjdqi0_1 /testbench/du_e/ddrphy_e/byte_g(0)/ddrdqphy_i/iddr_g(1)/adjdqi_b/adjdqi_e/delay
...
add wave -noupdate -expand -group adjdqi0_1 /testbench/du_e/ddrphy_e/byte_g(0)/ddrdqphy_i/iddr_g(1)/adjdqi_b/adjdqi_e/gaptab
add wave -noupdate -expand -group adjdqi0_1 /testbench/du_e/ddrphy_e/byte_g(0)/ddrdqphy_i/iddr_g(1)/adjdqi_b/adjdqi_e/tap4
add wave -noupdate -expand -group adjdqi0_1 /testbench/du_e/ddrphy_e/byte_g(0)/ddrdqphy_i/iddr_g(1)/adjdqi_b/adjdqi_e/tap4_gap
...
WaveRestoreCursors {{Cursor 1} {14366111 ps} 1} {{Cursor 2} {12085668 ps} 0} {{Cursor 3} {23744545 ps} 0} {{Cursor 4} {23754688 ps} 0}
...
update
WaveRestoreZoom {23733568 ps} {23764336 ps}
