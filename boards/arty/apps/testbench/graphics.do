...
add wave -noupdate -radix hexadecimal /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dq0
add wave -noupdate -radix hexadecimal /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dq1
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqs180
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqspre
add wave -noupdate -divider {New Divider}
...
WaveRestoreCursors {{Cursor 1} {14366111 ps} 1} {{Cursor 2} {13450068 ps} 0} {{Cursor 3} {23701601 ps} 0}
...
update
WaveRestoreZoom {23683105 ps} {23806153 ps}
