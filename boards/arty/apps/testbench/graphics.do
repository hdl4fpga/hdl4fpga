...
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/taps
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/clk
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/req
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/rdy
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/step_req
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/step_rdy
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/edge
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/smp
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/inv
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/delay
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/num_of_taps
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/num_of_steps
add wave -noupdate -expand /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/gaptab
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/dqsi_b/adjdqs_e/tap4
add wave -noupdate -divider {New Divider}
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/adjsto_req
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/adjsto_rdy
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/iddr_g(7)/adjdqi_b/adjdqi_e/req
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/iddr_g(7)/adjdqi_b/adjdqi_e/rdy
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/iddr_g(7)/adjdqi_b/step_rdy
add wave -noupdate /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/iddr_g(7)/adjdqi_b/step_req
...
add wave -noupdate -radix hexadecimal /testbench/du_e/ddrphy_e/byte_g(1)/ddrdqphy_i/adjdqi_rdy
add wave -noupdate -divider {New Divider}
...
WaveRestoreCursors {{Cursor 1} {14366111 ps} 1} {{Cursor 2} {12162800 ps} 0} {{Cursor 3} {13488973 ps} 0}
...
update
WaveRestoreZoom {11318599 ps} {15562055 ps}
