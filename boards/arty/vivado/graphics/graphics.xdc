...
set_false_path -from [ get_pins grahics_e/ddrctlr_b.ddrctlr_e/rdfifo_i/sys_do_win_reg/C                                                             ] -to [ get_pins grahics_e/ddrctlr_b.ddrctlr_e/rdfifo_i/bytes_g[*].DATA_PHASES_g[*].inbyte_i/phases_g[*].ar_g.gcntr_g[*].ffd_i/ffd_i/CLR ]
set_false_path -from [ get_pins ddrphy_e/byte_g[*].ddrdqphy_i/rl_b.adjdqs_req_reg/C                                                             ] -to [ get_pins grahics_e/ddrctlr_b.ddrctlr_e/rdfifo_i/datadelay_g.bytes_g[*].DATA_PHASES_g[*].inbyte_i/phases_g[*].ram_b/ram_g[*].ram_i/DP/I ]
set_false_path -from [ get_pins ddrphy_e/byte_g[*].ddrdqphy_i/rl_b.adjdqs_req_reg/C                                                             ] -to [ get_pins grahics_e/ddrctlr_b.ddrctlr_e/rdfifo_i/datadelay_g.bytes_g[*].DATA_PHASES_g[*].inbyte_i/phases_g[*].ram_b/ram_g[*].ram_i/SP/I ]
