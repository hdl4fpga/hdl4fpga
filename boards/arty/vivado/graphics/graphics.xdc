...
set_false_path -from [ get_pins grahics_e/ddrctlr_b.ddrctlr_e/ddr_init_e/ddr_init_rdy_reg/C                                                         ] -to [ get_pins ddrphy_e/byte_g[*].ddrdqphy_i/oddr_g[*].registered_g[*].gear_g[*].dqo_reg[*]/PRE ]
set_false_path -from [ get_pins grahics_e/ddrctlr_b.ddrctlr_e/ddr_init_e/ddr_init_rdy_reg/C                                                         ] -to [ get_pins ddrphy_e/byte_g[*].ddrdqphy_i/oddr_g[*].registered_g[*].gear_g[*].dqo_reg[*]/CLR ]