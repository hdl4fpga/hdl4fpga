...
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/adjdqs_e/line__79/start
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/iod_clk
...
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/adjdqs_e/step_req
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/adjdqs_e/step_rdy
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/adjdqs_e/phase
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/adjdqs_e/avrge
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/adjdqs_e/saved
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/adjdqs_e/sel
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/dqsidelay_i/rst
add wave -noupdate -radix unsigned /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/dqsidelay_i/delay
add wave -noupdate -radix unsigned /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/dqsidelay_i/idelay_i/idelay_count
add wave -noupdate /testbench/du_e/grahics_e/ctlrphy_dsi(0)
...
add wave -noupdate -divider {New Divider}
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/igbx_i/reg_g(0)/iserdese_g/xv5_g/iser_i/Q1
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/igbx_i/reg_g(0)/iserdese_g/xv5_g/iser_i/Q2
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/igbx_i/reg_g(0)/iserdese_g/xv5_g/iser_i/Q3
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/igbx_i/reg_g(0)/iserdese_g/xv5_g/iser_i/Q4
add wave -noupdate -divider {New Divider}
...
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/adjsto_e/sel
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/dqsi_b/adjsto_e/line__69/start
...
WaveRestoreCursors {{Cursor 1} {22194729 ps} 0} {{Cursor 2} {30120747 ps} 0}
...
update
WaveRestoreZoom {18022616 ps} {42567384 ps}
