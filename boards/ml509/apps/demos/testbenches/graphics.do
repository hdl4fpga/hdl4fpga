...
add wave -noupdate /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dqi
add wave -noupdate -divider {New Divider}
...
WaveRestoreCursors {{Cursor 1} {58060623 ps} 0} {{Cursor 2} {53666014 ps} 0}
...
update
WaveRestoreZoom {58014963 ps} {58122811 ps}
