...
add wave -noupdate -expand -group phy_rx -radix hexadecimal /testbench/mii_revrxd
...
add wave -noupdate -expand -group phy_tx -radix hexadecimal /testbench/mii_revtxd
...
add wave -noupdate -expand -group ddr2 -radix hexadecimal /testbench/du_e/ddr2_dqs_p
add wave -noupdate -expand -group ddr2 -radix hexadecimal /testbench/du_e/ddr2_dqs_n
...
add wave -noupdate -expand -group ddr2 /testbench/du_e/ddr2_dm
...
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/sdram_dq
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate /testbench/du_e/sdrphy_e/clk
...
WaveRestoreCursors {{Cursor 1} {22365000 ps} 0} {{Cursor 2} {41323268 ps} 0}
...
update
WaveRestoreZoom {41280460 ps} {41307978 ps}
