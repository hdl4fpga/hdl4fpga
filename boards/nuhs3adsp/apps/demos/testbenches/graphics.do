...
add wave -noupdate -divider {New Divider}
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/fifo_g/gear_g(1)/fifo_i/in_clk
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/fifo_g/gear_g(1)/fifo_i/in_frm
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/fifo_g/gear_g(1)/fifo_i/in_data
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/fifo_g/gear_g(1)/fifo_i/out_clk
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/fifo_g/gear_g(1)/fifo_i/out_frm
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/fifo_g/gear_g(1)/fifo_i/out_data
add wave -noupdate -divider {New Divider}
add wave -noupdate -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/sdqi
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
...
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate -group dmo /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/dmo_g/ogbx_i/reg_g(0)/gear2_g/xc3s_g/oddr_i/C0
add wave -noupdate -group dmo /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/dmo_g/ogbx_i/reg_g(0)/gear2_g/xc3s_g/oddr_i/D0
add wave -noupdate -group dmo /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/dmo_g/ogbx_i/reg_g(0)/gear2_g/xc3s_g/oddr_i/C1
add wave -noupdate -group dmo /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/dmo_g/ogbx_i/reg_g(0)/gear2_g/xc3s_g/oddr_i/D1
add wave -noupdate -divider {New Divider}
add wave -noupdate -group oddr_g2 /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/oddr_g(2)/ogbx_i/reg_g(0)/gear2_g/xc3s_g/oddr_i/C0
add wave -noupdate -group oddr_g2 /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datao_b/oddr_g(2)/ogbx_i/reg_g(0)/gear2_g/xc3s_g/oddr_i/D0
...
WaveRestoreCursors {{Cursor 1} {94732000 ps} 0} {{Cursor 2} {69214089 ps} 0} {{Cursor 3} {94823469 ps} 0}
...
update
WaveRestoreZoom {94713327 ps} {94753165 ps}
