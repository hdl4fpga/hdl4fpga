...
add wave -noupdate -divider {New Divider}
add wave -noupdate -expand -group byte_g1 /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sys_sti
add wave -noupdate -expand -group byte_g1 /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sys_sto
add wave -noupdate -expand -group byte_g1 /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_sti
add wave -noupdate -expand -group byte_g1 -radix hexadecimal -childformat {{/testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(7) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(6) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(5) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(4) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(3) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(2) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(1) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(0) -radix hexadecimal}} -subitemconfig {/testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(7) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(6) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(5) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(4) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(3) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(2) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(1) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq(0) {-height 29 -radix hexadecimal}} /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sdram_dq
add wave -noupdate -expand -group byte_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(1)/sdrdqphy_i/sys_dqo
add wave -noupdate -divider {New Divider}
...
add wave -noupdate -expand -group byte_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(1)
add wave -noupdate -expand -group byte_g0 /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_sti
add wave -noupdate -expand -group byte_g0 -radix hexadecimal -childformat {{/testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(7) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(6) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(5) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(4) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(3) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(2) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(1) -radix hexadecimal} {/testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(0) -radix hexadecimal}} -subitemconfig {/testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(7) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(6) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(5) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(4) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(3) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(2) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(1) {-height 29 -radix hexadecimal} /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq(0) {-height 29 -radix hexadecimal}} /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdram_dq
...
add wave -noupdate -expand /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/sdqso
add wave -noupdate -divider {New Divider}
add wave -noupdate -expand -group gear_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(1)/fifo_i/in_frm
add wave -noupdate -expand -group gear_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(1)/fifo_i/in_clk
add wave -noupdate -expand -group gear_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(1)/fifo_i/line__46/cntr
add wave -noupdate -expand -group gear_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(1)/fifo_i/in_data
add wave -noupdate -expand -group gear_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(1)/fifo_i/out_clk
add wave -noupdate -expand -group gear_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(1)/fifo_i/out_frm
add wave -noupdate -expand -group gear_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(1)/fifo_i/line__57/cntr
add wave -noupdate -expand -group gear_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(1)/fifo_i/out_data
add wave -noupdate -expand -group gear_g1 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(1)/fifo_i/mem
add wave -noupdate -divider {New Divider}
add wave -noupdate -expand -group gear_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(0)/fifo_i/in_frm
add wave -noupdate -expand -group gear_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(0)/fifo_i/in_clk
add wave -noupdate -expand -group gear_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(0)/fifo_i/line__46/cntr
add wave -noupdate -expand -group gear_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(0)/fifo_i/in_data
add wave -noupdate -expand -group gear_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(0)/fifo_i/out_clk
add wave -noupdate -expand -group gear_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(0)/fifo_i/out_frm
add wave -noupdate -expand -group gear_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(0)/fifo_i/line__57/cntr
add wave -noupdate -expand -group gear_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(0)/fifo_i/out_data
add wave -noupdate -expand -group gear_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrdqphy_i/datai_b/rdfifo_g/gear_g(0)/fifo_i/mem
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
