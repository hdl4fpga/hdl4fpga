...
\frametitle{Multiplexado de la dirección}
	...
	\begin{center}
		...
		Memory Card with Integrated circuit Micron MT4C1024 1 Mbit DRAM chip. Die size 8662x3969 $\mu m$
	\end{center}
\end{frame}
...
\frametitle{Ley de Moore}
	\begin{itemize}
		...
		\item Duplicacion de componentes por año en los circuitos integrados
	\end{itemize}
	\begin{center}
...
\frametitle{FPGAs Field Programmable Gate Arrays}
	\begin{itemize}
		...
		\item Intel compra Altera pricipal competidor de Xilinx en el 2015.\
			La acción de Altera paso de valer 30 USD a valer 50 USD (9/2015)
	\end{itemize}
\end{frame}
...
\frametitle{Ventajas}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Reprogramables para actualizaciones en el diseño
		\end{itemize}
	\end{itemize}
\end{frame}
...
\frametitle{Nu Horizons Spartan 3A DSP kit}
	\begin{itemize}
		...
		\item Spartan 3A DSP
			...
			\end{itemize}
		\item 32 MBytes de Memoria DDR1 333
		\item 2 ADC
			\begin{itemize}
				\item Diferencial
				\item 14 bits
...
\begin{frame}
	\begin{center}
		$y[n] = \sum\limits_{i=0}^84\ h[i]*x[n-i]$
	\end{center}
	\begin{minipage}[c]{5.5cm}
