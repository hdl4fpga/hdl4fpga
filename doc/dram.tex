...
\frametitle{Convolución}
	\begin{columns}[t]
		...
		Frecuencia 2.66 Ghz
		Ciclo de .375 ps
		Un resultado cada 84 ejecuciones del lazo
		Un lazo 7 instrucciones
		Total instrucciones por resultado 7*84 = 588
		Conciderando 2.5 instrucciones por ciclo promedio 588/2.5 ciclos
		Un resultado cada 235*.375 = 88 ns
	\end{columns}
	\begin{center}
		Spartan3DSP/Corei7 = 88 ns/4ns = 22 
...
\begin{frame}
	...
	Se requiere memoeria DRAM
	La transferencia de datos debe ser rápida para poder sostener la tasa de trasnferencia
\end{frame}
...
\frametitle{Processor Unit}
	\begin{itemize}
		\item Implementa el ciclo crítco, el acceso los datos.
		\item Secuencia el cambio de estados
		\item Conforma las latencias de las instrucciones
		\item Busca la siguiente instrucción previo a finalizar el último ciclo de la actual
	\end{itemize}
\end{frame}
