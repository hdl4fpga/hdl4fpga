...
{\small
	\justifying
Los dispositivos denominados FPGAs comienzan a desplazar en aplicaciones de
...
aplicación y la misma, se programa en la FPGA y debe ser capaz de transferir
datos desde y hacia la memoria de manera de alcanzar las velocidades máximas
que ofrecen los recursos de la FPGA y de esta forma aprovechar todo su potencial.
...
\frametitle{Gate Arrays o Arreglos de Compuertas}
	...
	\column{0.6\textwidth}
		{\small
		\begin{itemize}
		\item C.I. con compuertas y bloques prearmandos.
		\item Ventajas
		{\small
			\begin{itemize}
...
{\scriptsize
"S-MOS Systems ASIC SLA6140" \\ by Antoinebercovici}
		\end{center}
	\end{columns}
\end{frame}
...
\begin{frame}[t]
\frametitle{Algoritmo en Lenguaje C y en Assembly Optimizado}
...
\begin{tabular}[t]{|r|c|c|c|}
	...
	\textcolor{blue}{Fabricante}            & Xilinx & Xilinx & LatticeSemi \\
...
\begin{frame}
\frametitle{Síntesis}
\framesubtitle{LatticeECP3 Versa Kit}
	\begin{center}
...
\begin{itemize}
	\item Código Portable.
	\item Descripción a nivel de compuerta en VHDL.
	\item Más de un 20\% de aumento de velocidad de transferencia comparado contra el módulo de los respectivos fabricantes.
\end{itemize}
\end{frame}
%Design Summary
