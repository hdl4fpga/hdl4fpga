...
\framesubtitle{Ejemplo de aplicación : Convolución}
	...
	\end{block}
	\end{columns}
	\begin{block}{Aumento de velocidad}
	\begin{center}
...
\begin{frame}
\frametitle{Diagrama en bloque del Chip de DDR3 DRAM}
	\begin{center}
...
\frametitle{Processor Unit}
	\begin{itemize}
		\item Temporización de los comandos
			\begin{itemize}
				\item ACT
				\item READ
				\item WRITE
...
\begin{frame}
\frametitle{Fragmento del código de la especificación}
\framesubtitle{VHDL}
	\begin{center}
		\lstinputlisting[language=VHDL,
			...
			keywordstyle=\color{blue}\ttfamily,
			stringstyle=\color{red}\ttfamily,
			commentstyle=\color{brown}\ttfamily]{xdrinit.vhd}
	\end{center}
\end{frame}
...
\frametitle{Resultado de la síntesis}
	\begin{center}
		\includegraphics[width=0.6\textwidth]{ddr3ctrl.png}
	\end{center}
\end{frame}
