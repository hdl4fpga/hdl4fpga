...
\frametitle{UNIVAC I UNIVersal Automatic Computer I}
	\begin{itemize}
		...
		\item 1.000 palabras de 11 digitos decimales
...
\subsection{Ciclo ACT}
\begin{frame}
\frametitle{ACT}
\framesubtitle{Diagrama de tiempo}
	\begin{center}
		\includegraphics[height=0.8\textheight]{ddr3act.eps}
	\end{center}
\end{frame}

\subsection{Ciclo READ}
\begin{frame}
\frametitle{BURST READ MODE}
\framesubtitle{Diagrama de tiempo}
	\begin{center}
		\includegraphics[height=0.8\textheight]{ddr3rdbrst.eps}
	\end{center}
\end{frame}

\begin{frame}
\frametitle{NON BURST READ MODE}
\framesubtitle{Diagrama de tiempo}
	\begin{center}
		\includegraphics[height=0.8\textheight]{ddr3nrdbrst.eps}
	\end{center}
\end{frame}

\subsection{Ciclo WRITE}
\begin{frame}
\frametitle{BURST WRITE MODE}
\framesubtitle{Diagrama de tiempo}
	\begin{center}
		\includegraphics[height=0.8\textheight]{ddr3wrbrst.eps}
	\end{center}
\end{frame}

\begin{frame}
\frametitle{NON BURST WRITE MODE}
\framesubtitle{Diagrama de tiempo}
	\begin{center}
		\includegraphics[height=0.8\textheight]{ddr3nwrbrst.eps}
	\end{center}
\end{frame}

\subsection{Ciclo PRE}
\begin{frame}
\frametitle{READ PRE}
\framesubtitle{Diagrama de tiempo}
	\begin{center}
		\includegraphics[height=0.8\textheight]{ddr3readpre.eps}
	\end{center}
\end{frame}

\begin{frame}
\frametitle{WRITE PRE}
\framesubtitle{Diagrama de tiempo}
	\begin{center}
		\includegraphics[height=\textheight]{ddr3writepre.eps}
	\end{center}
\end{frame}

\subsection{Ciclo REF}
\begin{frame}
\frametitle{REF}
\framesubtitle{Diagrama de tiempo}
	\begin{center}
		\includegraphics[height=0.8\textheight]{ddr3ref.eps}
	\end{center}
\end{frame}
...
\begin{frame}
\frametitle{Inicializacion}
\framesubtitle{Diagrama de tiempo}
	\begin{center}
		\includegraphics[height=0.8\textheight]{ddr3init.eps}
	\end{center}
\end{frame}
