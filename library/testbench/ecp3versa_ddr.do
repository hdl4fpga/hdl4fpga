...
add wave -noupdate /testbench/du_e/ddr3_clk
...
add wave -noupdate -expand -group micron -radix hexadecimal /testbench/mt_u/ba
add wave -noupdate -expand -group micron -radix hexadecimal /testbench/mt_u/addr
add wave -noupdate -expand -group micron /testbench/mt_u/dq
...
WaveRestoreCursors {{Cursor 5} {200785000000 fs} 0}
...
update
WaveRestoreZoom {200776989130 fs} {200793010870 fs}
