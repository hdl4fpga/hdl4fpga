...
add wave -noupdate /testbench/du_e/e_rx_clk
add wave -noupdate /testbench/du_e/e_rx_dv
add wave -noupdate -radix hexadecimal /testbench/du_e/e_rxd
...
add wave -noupdate -radix hexadecimal -childformat {{/testbench/du_e/graphics_e/video_pixel(0) -radix hexadecimal} {/testbench/du_e/graphics_e/video_pixel(1) -radix hexadecimal} {/testbench/du_e/graphics_e/video_pixel(2) -radix hexadecimal} {/testbench/du_e/graphics_e/video_pixel(3) -radix hexadecimal} {/testbench/du_e/graphics_e/video_pixel(4) -radix hexadecimal} {/testbench/du_e/graphics_e/video_pixel(5) -radix hexadecimal} {/testbench/du_e/graphics_e/video_pixel(6) -radix hexadecimal} {/testbench/du_e/graphics_e/video_pixel(7) -radix hexadecimal}} -subitemconfig {/testbench/du_e/graphics_e/video_pixel(0) {-height 29 -radix hexadecimal} /testbench/du_e/graphics_e/video_pixel(1) {-height 29 -radix hexadecimal} /testbench/du_e/graphics_e/video_pixel(2) {-height 29 -radix hexadecimal} /testbench/du_e/graphics_e/video_pixel(3) {-height 29 -radix hexadecimal} /testbench/du_e/graphics_e/video_pixel(4) {-height 29 -radix hexadecimal} /testbench/du_e/graphics_e/video_pixel(5) {-height 29 -radix hexadecimal} /testbench/du_e/graphics_e/video_pixel(6) {-height 29 -radix hexadecimal} /testbench/du_e/graphics_e/video_pixel(7) {-height 29 -radix hexadecimal}} /testbench/du_e/graphics_e/video_pixel
...
WaveRestoreCursors {{Cursor 1} {202269668 ps} 0}
...
update
WaveRestoreZoom {202265144 ps} {202559541 ps}
