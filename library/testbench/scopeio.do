...
add wave -noupdate -radix hexadecimal /testbench/scopeio_e/downsampler_e/line__47/scaler
...
add wave -noupdate /testbench/scopeio_e/downsampler_e/scaler_sync
add wave -noupdate -divider {New Divider}
add wave -noupdate /testbench/scopeio_e/xxx/scopeio_capture_e/capture_start
add wave -noupdate /testbench/scopeio_e/xxx/scopeio_capture_e/capture_finish
...
WaveRestoreCursors {{Cursor 1} {2146212 ns} 0} {{Cursor 3} {2314556 ns} 0}
...
update
WaveRestoreZoom {2313143 ns} {2315857 ns}
