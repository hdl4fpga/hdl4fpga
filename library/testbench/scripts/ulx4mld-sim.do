...
add wave -noupdate -expand -group sdrphy_e -expand -group byte_g0 -radix hexadecimal /testbench/du_e/sdrphy_e/byte_g(0)/sdrphy_i/sys_dqo
...
add wave -noupdate -divider {New Divider}
add wave -noupdate -radix hexadecimal /testbench/du_e/dvid_crgb
add wave -noupdate -divider {New Divider}
...
add wave -noupdate -radix hexadecimal /testbench/du_e/graphics_e/adapter_b/graphics_e/srcgtdst_g/vram_word
add wave -noupdate -divider {New Divider}
add wave -noupdate /testbench/du_e/graphics_e/adapter_b/graphics_e/srcgtdst_g/vram_trdy
add wave -noupdate -divider {New Divider}
add wave -noupdate /testbench/du_e/graphics_e/adapter_b/graphics_e/video_on
add wave -noupdate /testbench/du_e/graphics_e/adapter_b/graphics_e/srcgtdst_g/deslzr_e/dst_frm
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
...
WaveRestoreCursors {{Cursor 1} {127962602090 fs} 0} {{Cursor 2} {63940610480 fs} 0}
...
update
WaveRestoreZoom {127545696050 fs} {128677727410 fs}
