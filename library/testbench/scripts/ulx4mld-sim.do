...
add wave -noupdate -radix hexadecimal /testbench/du_e/ipoe_e/rgmii_e/udpdaisy_e/sio_udp_e/mii_ipoe_e/ethrx_e/fcs_rem
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
...
WaveRestoreCursors {{Cursor 1} {35077507280 fs} 0} {{Cursor 2} {37640047920 fs} 0}
...
update
WaveRestoreZoom {37545558590 fs} {37710441410 fs}
