...
add wave -noupdate -divider {New Divider}
add wave -noupdate /testbench/dev_b/dev_e/tp(1)
add wave -noupdate /testbench/dev_b/dev_e/tp(2)
add wave -noupdate /testbench/dev_b/dev_e/tp(3)
add wave -noupdate -divider {New Divider}
add wave -noupdate -radix hexadecimal /testbench/dev_b/tp_p/data
add wave -noupdate -divider {New Divider}
add wave -noupdate -divider {New Divider}
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {6569325 ps} 1} {{Cursor 2} {8757476 ps} 1} {{Cursor 3} {2163545 ps} 1} {{Cursor 4} {3408340 ps} 1} {{Cursor 5} {17677890 ps} 0}
...
update
WaveRestoreZoom {0 ps} {18081092 ps}
