...
add wave -noupdate /testbench/rx_crc
add wave -noupdate /testbench/crc_e/clk
add wave -noupdate /testbench/crc_e/frm
add wave -noupdate /testbench/crc_e/irdy
add wave -noupdate /testbench/crc_e/data
add wave -noupdate /testbench/crc_e/crc
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {11779637 ps} 0} {{Cursor 2} {3650034 ps} 0}
...
update
WaveRestoreZoom {6516250 ps} {13341250 ps}
