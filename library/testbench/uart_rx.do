...
add wave -noupdate -radix hexadecimal -childformat {{/testbench/uartrx_e/line__54/tcntr(0) -radix hexadecimal} {/testbench/uartrx_e/line__54/tcntr(1) -radix hexadecimal} {/testbench/uartrx_e/line__54/tcntr(2) -radix hexadecimal} {/testbench/uartrx_e/line__54/tcntr(3) -radix hexadecimal} {/testbench/uartrx_e/line__54/tcntr(4) -radix hexadecimal}} -subitemconfig {/testbench/uartrx_e/line__54/tcntr(0) {-height 16 -radix hexadecimal} /testbench/uartrx_e/line__54/tcntr(1) {-height 16 -radix hexadecimal} /testbench/uartrx_e/line__54/tcntr(2) {-height 16 -radix hexadecimal} /testbench/uartrx_e/line__54/tcntr(3) {-height 16 -radix hexadecimal} /testbench/uartrx_e/line__54/tcntr(4) {-height 16 -radix hexadecimal}} /testbench/uartrx_e/line__54/tcntr
add wave -noupdate -radix hexadecimal /testbench/uartrx_e/line__54/dcntr
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {82900 ns} 0} {{Cursor 2} {48219 ns} 0}
