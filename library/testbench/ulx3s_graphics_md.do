...
add wave -noupdate -divider {New Divider}
add wave -noupdate -expand -group sio_udp /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_frm
add wave -noupdate -expand -group sio_udp /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_irdy
add wave -noupdate -expand -group sio_udp /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_trdy
add wave -noupdate -expand -group sio_udp /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/rev_so_data001
add wave -noupdate -expand -group sio_udp -radix hexadecimal -childformat {{/testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(0) -radix hexadecimal} {/testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(1) -radix hexadecimal} {/testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(2) -radix hexadecimal} {/testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(3) -radix hexadecimal} {/testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(4) -radix hexadecimal} {/testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(5) -radix hexadecimal} {/testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(6) -radix hexadecimal} {/testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(7) -radix hexadecimal}} -expand -subitemconfig {/testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(0) {-radix hexadecimal} /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(1) {-radix hexadecimal} /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(2) {-radix hexadecimal} /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(3) {-radix hexadecimal} /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(4) {-radix hexadecimal} /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(5) {-radix hexadecimal} /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(6) {-radix hexadecimal} /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data(7) {-radix hexadecimal}} /testbench/du_e/ipoe_g/mii_e/udpdaisy_e/sio_udp_e/so_data
...
WaveRestoreCursors {{Cursor 1} {2887500000 fs} 0} {{Cursor 2} {6803938050 fs} 0}
...
update
WaveRestoreZoom {6396250 ps} {7971250 ps}
