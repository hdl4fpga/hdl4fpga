...
add wave -noupdate /testbench/nuhs3dsp_e/ddrphy_e_ddrbaphy_i_cke_i_ffd_i/CLK
add wave -noupdate /testbench/nuhs3dsp_e/scope_e_ddr_e_xdr_init_e_xdr_init_cke/CE
add wave -noupdate /testbench/nuhs3dsp_e/scope_e_ddr_e_xdr_init_e_xdr_init_cke/I
add wave -noupdate /testbench/nuhs3dsp_e/scope_e_ddr_e_xdr_init_e_xdr_init_cke/O
add wave -noupdate /testbench/nuhs3dsp_e/scope_e_ddr_e_xdr_init_e_xdr_init_cke/RST
add wave -noupdate /testbench/nuhs3dsp_e/scope_e_ddr_e_xdr_init_e_xdr_init_cke/SRST
add wave -noupdate /testbench/nuhs3dsp_e/scope_e_ddr_e_xdr_init_e_xdr_init_cke/SSET
add wave -noupdate /testbench/nuhs3dsp_e/scope_e_ddr_e_xdr_init_e_xdr_init_cke/SET
add wave -noupdate /testbench/nuhs3dsp_e/scope_e_ddr_e_xdr_mr_addr
add wave -noupdate /testbench/nuhs3dsp_e/scope_e_ddr_e_xdr_mr_data
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {21695247 ps} 0} {{Cursor 2} {2207569 ps} 0}
...
update
WaveRestoreZoom {3490660 ps} {4298746 ps}
