...
add wave -noupdate -radix hexadecimal -childformat {{/testbench/win_sytm_e/col_cnt(0) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(1) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(2) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(3) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(4) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(5) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(6) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(7) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(8) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(9) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(10) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(11) -radix hexadecimal} {/testbench/win_sytm_e/col_cnt(12) -radix hexadecimal}} -subitemconfig {/testbench/win_sytm_e/col_cnt(0) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(1) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(2) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(3) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(4) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(5) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(6) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(7) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(8) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(9) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(10) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(11) {-height 16 -radix hexadecimal} /testbench/win_sytm_e/col_cnt(12) {-height 16 -radix hexadecimal}} /testbench/win_sytm_e/col_cnt
...
WaveRestoreCursors {{Cursor 1} {16409035197 ps} 0}
...
update
WaveRestoreZoom {16351096966 ps} {16486449286 ps}
